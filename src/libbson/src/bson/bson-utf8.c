                           ...
                           ssize_t utf8_len) /* IN */
{
   ...
   mcommon_string_t *string = mcommon_string_new_with_capacity ("", 0, len32);
   mcommon_string_append_t append;
   mcommon_string_append_init (&append, string);

   if (mcommon_json_append_escaped (&append, utf8, len32, allow_nul)) {
      return mcommon_string_destroy_into_buffer (string);
   } else {
